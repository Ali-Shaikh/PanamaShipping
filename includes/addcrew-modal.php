        ...
        <div class="modal-content">
            ...
            <div class="modal-body step-1" data-step="1">
                <form role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formInput23" placeholder="Date Started Working at the Company">
                    </div>
                </form>
            </div>
            <div class="modal-body step-2" data-step="2">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" id="date3" name="date3" placeholder="MM/DD/YYYY" type="text"/>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" id="date4" name="date4" placeholder="MM/DD/YYYY" type="text"/>
                </div>
                <div class="form-group col-md-4">
                    <label class="control-label " for="date5">
                        Date
                    </label>
                    <input class="form-control" id="date5" name="date5" placeholder="MM/DD/YYYY" type="text"/>
                </div>
                <div class="form-group col-md-6">
